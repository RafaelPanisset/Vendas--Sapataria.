    ...
    public ModelConta getContaPagarDAO(int pCodigo) {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelConta.setParcelas(this.getResultSet().getInt(12));
                modelConta.setChequeOutro(this.getResultSet().getInt(13));
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean atualizarContaPagarDAO(ModelConta pModelContaPagar) {
        try {
            ...
            return this.executarUpdateDeleteSQL(
                    ...
                    + "fk_codigo_fornecedor = '" + pModelContaPagar.getCodigoPessoa() + "',"
                    ...
                    + "parcelas = '" + pModelContaPagar.getParcelas() + "',"
                    + "chequeOutro = '" + pModelContaPagar.getParcelas() + "'"
                    + " WHERE "
                    + "pk_codigo = '" + pModelContaPagar.getCodigo() + "'"
                    + ";"
            );
...
//                    "UPDATE contas SET "
//                    + "pk_codigo = '" + pModelContaPagar.getCodigo() + "',"
//                    + "fk_codigo_p = '" + pModelContaPagar.getCodigoPessoa() + "',"
//                    + "descricao = '" + pModelContaPagar.getDescricao() + "',"
//                    + "data = '" + pModelContaPagar.getData() + "',"
//                    + "vencimento = '" + pModelContaPagar.getVencimento() + "',"
//                    + "pagamento = '" + pModelContaPagar.getPagamento() + "',"
