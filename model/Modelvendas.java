...
public class Modelvendas {
    ...
    */
    ...
    public String toString(){
        return "Modelvendas {" + "::idVendas = " + this.idVendas + "::cliente = " + this.cliente + "::venDataVenda = " + this.venDataVenda + "::venValorLiquido = " + this.venValorLiquido + "::venValorBruto = " + this.venValorBruto + "::venDesconto = " + this.venDesconto + "::idContaReceber = " + this.idContaReceber + "}";
    }
